...
public class SpendingReportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String startDateText = startDateParts[2] + "-" + startDateParts[1]
            + "-" + startDateParts[0];
        String endDateText = endDateParts[2] + "-" + endDateParts[1] + "-"
            + endDateParts[0];
        String newSD = startDateParts[0] + startDateParts[1]
            + startDateParts[2];
        String newED = endDateParts[0] + endDateParts[1] + endDateParts[2];
        title.setText("Spending Report for " + startDateText + " to "
            + endDateText);
