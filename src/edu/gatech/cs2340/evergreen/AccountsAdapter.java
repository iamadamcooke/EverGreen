...
public class AccountsAdapter extends ArrayAdapter<Account> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView accountNameText = (TextView) rowView
            .findViewById(R.id.account_name_text);
        TextView displayNameText = (TextView) rowView
            .findViewById(R.id.display_name_text);
        TextView balanceText = (TextView) rowView
            .findViewById(R.id.balance_text);
        TextView interestRateText = (TextView) rowView
            .findViewById(R.id.interest_rate_text);
